                        ...
                        <div class="col-lg-12">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">Please Register before login!</h1>
                                </div>
                                ...
                                <form class="user" action="{{route('visitor_login.store')}}" method="post">
                                    ...
                                    <input type="hidden" name="back_url" value="?url={{isset($url) ? $url : ''}}">
                                ...
                                <div class="text-center">
                                    <a class="small" href="{{route('comment.index')}}?url={{isset($url) ? $url : ''}}">Already
                                        registered!</a>
                                </div>
                            </div>
                        </div>
